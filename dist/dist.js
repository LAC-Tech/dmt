...
unwrapExports(core);
var core_1 = core.combineSummaries;
var core_2 = core.isTestResult;
var core_3 = core.evaluateSuite;
var core_4 = core.deepMap;
...
var diffJson = index_es6.diffJson;
...
var success = function (text) { return litHtml.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<span class=\"success\">", "</span>"], ["<span class=\"success\">", "</span>"])), text); };
var fail = function (text) { return litHtml.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<span class=\"fail\">", "</span>"], ["<span class=\"fail\">", "</span>"])), text); };
var testOutput = function (templates) { return litHtml.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\t<div class=\"result\"><pre>", "</pre></div>"], ["\n\t<div class=\"result\"><pre>", "</pre></div>"])), templates); };
var text = function (type, str, n) {
    if (n == 0)
        return litHtml.html(templateObject_4 || (templateObject_4 = __makeTemplateObject([""], [""])));
    return litHtml.html(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n\t\t<span class=", ">\n\t\t\t", "<small><sub>", "</sub></small>\n\t\t</span>"], ["\n\t\t<span class=", ">\n\t\t\t", "<small><sub>", "</sub></small>\n\t\t</span>"])), type, str, n);
};
...
var node = function (_a) {
    ...
    return litHtml.html(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\t\t<details ?open=", ">\n\t\t\t<summary class=", ">\n\t\t\t\t<b>", "</b>\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t</summary>\n\t\t\t", "\n\t\t</details>"], ["\n\t\t<details ?open=", ">\n\t\t\t<summary class=", ">\n\t\t\t\t<b>", "</b>\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t</summary>\n\t\t\t", "\n\t\t</details>"])), fails != 0, "h" + depth, name, text('success', '✓', passes), text('fail', '✖', fails), views);
};
exports.node = node;
var diff = function (description, lines) {
    ...
    return litHtml.html(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\t\t<div class=\"result\">\n\t\t\t<pre>", "", "</pre>\t\t\t\n\t\t\t<pre class='diff'>", "</pre>\n\t\t</div>"], ["\n\t\t<div class=\"result\">\n\t\t\t<pre>", "", "</pre>\t\t\t\n\t\t\t<pre class='diff'>", "</pre>\n\t\t</div>"])), fail('✖'), description, diffLines);
};
var root = function (views) { return litHtml.html(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n\t<style>\n\t.h1 {\n\t\tmargin-left: 0em;\t\n\t}\n\n\t.h2 {\n\t\tmargin-left: 0.5em;\n\t}\n\n\t.h3 {\n\t\tmargin-left: 1em;\n\t}\n\n\t.h4 {\n\t\tmargin-left: 1.5em;\n\t}\n\n\t.h5 {\n\t\tmargin-left: 2em\n\t}\n\n\t.h6 {\n\t\tmargin-left: 2.5em;\n\t}\n\n\t.h7 {\n\t\tmargin-left: 3em;\n\t}\n\n\thtml {\n\t\tcolor: whitesmoke;\n\t\tbackground: #000007;\n\t\tfont-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n\t}\n\n\tdetails summary {\n\t\tfont-size: smaller;\n\t\tletter-spacing: 0.075em;\n\t}\n\n\t@media (min-width:960px) {\n\t\thtml {\n\t\t\tfont-size: x-large;\n\t\t}\n\t}\n\n\t.success {\t\n\t\tcolor: #5fff5f;\n\t}\n\n\t.fail {\n\t\tcolor: #ff5f5f;\n\t}\n\n\t.success, .fail {\n\t\tpadding-right: 0.125rem;\n\t}\n\n\t.diff {\n\t\tfont-size: smaller;\n\t}\n\n\t.result {\n\t\tfont-family: monospace;\n\t\tmargin-left: 2em;\n\t}\n\n\tpre {\n\t\tmargin: 0;\n\t}\n\t</style>\n\t<div>", "</div>"], ["\n\t<style>\n\t.h1 {\n\t\tmargin-left: 0em;\t\n\t}\n\n\t.h2 {\n\t\tmargin-left: 0.5em;\n\t}\n\n\t.h3 {\n\t\tmargin-left: 1em;\n\t}\n\n\t.h4 {\n\t\tmargin-left: 1.5em;\n\t}\n\n\t.h5 {\n\t\tmargin-left: 2em\n\t}\n\n\t.h6 {\n\t\tmargin-left: 2.5em;\n\t}\n\n\t.h7 {\n\t\tmargin-left: 3em;\n\t}\n\n\thtml {\n\t\tcolor: whitesmoke;\n\t\tbackground: #000007;\n\t\tfont-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n\t}\n\n\tdetails summary {\n\t\tfont-size: smaller;\n\t\tletter-spacing: 0.075em;\n\t}\n\n\t@media (min-width:960px) {\n\t\thtml {\n\t\t\tfont-size: x-large;\n\t\t}\n\t}\n\n\t.success {\t\n\t\tcolor: #5fff5f;\n\t}\n\n\t.fail {\n\t\tcolor: #ff5f5f;\n\t}\n\n\t.success, .fail {\n\t\tpadding-right: 0.125rem;\n\t}\n\n\t.diff {\n\t\tfont-size: smaller;\n\t}\n\n\t.result {\n\t\tfont-family: monospace;\n\t\tmargin-left: 2em;\n\t}\n\n\tpre {\n\t\tmargin: 0;\n\t}\n\t</style>\n\t<div>", "</div>"])), views); };
exports.root = root;
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8;
});

unwrapExports(views);
var views_1 = views.testResult;
var views_2 = views.node;
var views_3 = views.root;
...
exports.evaluateSuite = core.evaluateSuite;

var run = function (elem, _a) {
    var client = _a.client, server = _a.server;
    return __awaiter(void 0, void 0, void 0, function () {
        var suite, _b, _c, views$1, summary, fails;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = {
                    ...
                    return [4 /*yield*/, core.evaluateSuite(client || {})];
                case 1:
                    suite = (_b.client = _d.sent(),
                        _b);
                    return [4 /*yield*/, render(name, suite, 0)];
                case 2:
                    _c = _d.sent(), views$1 = _c.views, summary = _c.summary;
                    fails = summary.fails;
                    document.title = "tests " + (fails == 0 ? '✓' : "\u2716" + fails);
                    litHtml.render(views.root(views$1), elem);
                    return [2 /*return*/];
            }
        });
    });
...
var render = function (name, suite, depth) { return __awaiter(void 0, void 0, void 0, function () {
    var success, summary_1, asyncChildren, children, views$1, summary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (core.isTestResult(suite)) {
                    success = suite.kind === 'success';
                    summary_1 = success ? { passes: 1, fails: 0 } : { passes: 0, fails: 1 };
                    return [2 /*return*/, { summary: summary_1, views: views.testResult(name, suite) }];
                }
            ...
            case 1:
                children = _a.sent();
                views$1 = children.flatMap(views.node);
                summary = core.combineSummaries(children.map(function (c) { return c.summary; }));
                return [2 /*return*/, { views: views$1, summary: summary }];
        }
    });
}); };
});
...
var dist_1 = dist.evaluateSuite;
var dist_2 = dist.run;

export default index;
export { dist_1 as evaluateSuite, dist_2 as run };
